...
const Rooms: React.FC = () => (
  <div>
    ...
    <RoomCard title="Interior Stateroom" imageSrc="/img6.png" price="$****">
      After an action-packed schedule of meetings, activities, and exploring the
      world, you need to relax. At the end of a busy day, retreat to your
    ...
    <RoomCard title="Ocean View Stateroom" imageSrc="/img7.png" price="$****">
      As your Royal Caribbean cruise sails to some of the world’s most stunning
      destinations, you don’t want to miss a single moment.
      <br />
      <br />
    ...
    <RoomCard title="Suite Stateroom" imageSrc="/img9.png" price="$****">
      ...
      departure privileges, and dedicated entertainment seating, everything you
      need for a lavish voyage is at your fingertips.
      <br />
      <br />
      For an extra-special journey, select Royal Suite Class, with its exclusive
      experiences, deluxe amenities, and the most spacious luxury suites at sea.
      No matter which suite you choose, experience Royal Caribbean’s legendary
      personalized service, spacious accommodations, and special touches at
      every turn.
    </RoomCard>
  </div>
);
