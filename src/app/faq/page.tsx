...
const FAQPage: React.FC = () => (
  <div className="bg-white">
    ...
    <Card title="Cancellations / Changes">
      ...
      <br />
      Changes made to an existing reservation within 120 days of the embarkation
      date are subject to a $150 manifest change fee.
    </Card>
    <Card title="Travel Insurance">
      Seminar on the Seas strongly encourages the purchase of Travel Insurance.
      All payments made for a Reservation are non-refundable at the time of
      payment.
      <br />
      <br />
      ...
      Insurance must be purchased within 14 days of the payment of your deposit.
    </Card>
    <Card title="Travel Documentation">
      Seminar on the Seas strongly recommend that all guests travel with a valid
      passport with at least six (6) months validity during their cruise. <br />
      <br />
      ...
      scheduled embarkation in a U.S. port; guests entering the U.S. at the end
      of their cruise; and guests needing to fly to the U.S. before their cruise
      ends because of medical, family, personal or business emergencies, missing
      a ship’s departure from a port of call, involuntary disembarkation from a
      ship due to misconduct, or other reasons.
      <br />
      <br />
